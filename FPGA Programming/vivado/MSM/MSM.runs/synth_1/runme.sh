...
HD_PWD='C:/Users/miche/Desktop/Uni/EaCS/VHDLProjects/MSM/vivado/MSM/MSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MSM_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MSM_wrapper.tcl
