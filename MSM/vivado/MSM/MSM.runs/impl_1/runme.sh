...
HD_PWD='C:/Users/miche/Desktop/Uni/EaCS/VHDLProjects/MSM/vivado/MSM/MSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MSM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MSM_wrapper.tcl -notrace
